...
function pintarCarta(x, y) {
  ...
  /*
   * OBTENEMOS EL TAMAÑO REAL DE LA CARTA.
   * Así la pintura siempre utiliza exactamente
   * la misma proporción que la carta azul.
   */
  ...
  /*
   * LIMITAMOS LAS COORDENADAS AL ÁREA REAL.
   */
  ...
  if (
    zonasPintadas.has(clave)
  ) {
    return;
  }


  zonasPintadas.add(clave);
  ...
  /*
   * LA POSICIÓN SE GUARDA DESDE EL MISMO
   * SISTEMA DE COORDENADAS DE LA CARTA.
   */
   ...
   * CON EL TAMAÑO REAL DE LA CARTA.
   */
