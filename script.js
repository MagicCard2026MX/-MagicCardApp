...
/*
   ...
   Es grande para que unas 5-6
   pasadas sean suficientes.
*/

const BROCHA_ANCHO = 72;
const BROCHA_ALTO = 72;


/*
   Distancia entre zonas.
   Ya no usamos círculos pequeños.
*/

const TAMANO_ZONA = 45;


/*
   Guardamos las zonas ya cubiertas.
*/
...
/*
   ...
   Sirve para crear un trazo continuo.
*/
...
function pintarTrayecto(
  ...
  /*
   * Más puntos cuando el movimiento
   * es más largo.
   */
...
function pintarCarta(x, y) {
  ...
  /*
   * IMPORTANTE:
   * ahora la pintura usa
   * el tamaño real de la carta.
   */
  ...
  /*
   * Ya no hacemos círculos.
   */

  pintura.style.borderRadius =
    "0";
...
function revisarCarta() {
  ...
  /*
   * 70% es suficiente porque
   * cada brocha cubre una zona
