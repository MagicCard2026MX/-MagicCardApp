...
document.addEventListener(
  ...
  function(e) {
    ...
    /*
     * LA PUNTA SE ACERCA AL DEDO
     * PARA QUE PUEDA LLEGAR HASTA
     * LA ORILLA DERECHA DE LA CARTA.
     */
...
function pintarCarta(x, y) {
  ...
  const ANCHO_PINTURA = 72;

  const ALTO_PINTURA = 72;
...
/* =========================================
   REINICIAR POSICIÓN DEL PLUMÓN
   ========================================= */

function reiniciarPosicionPintura() {
