...
function pintarCarta(
  ...
  /*
   * Convertimos la posición real del dedo
   * a las coordenadas originales de la carta.
   */
  ...
  /*
   * La pintura se coloca centrada
   * exactamente en el punto del plumón.
   */
  ...
  /*
   * Esta posición hace que la imagen azul
   * coincida con la carta azul inferior.
   */
...
function revisarCarta() {
  ...
  /*
   * Se mantiene una cobertura alta,
   * pero la pintura es mucho más grande.
   */
