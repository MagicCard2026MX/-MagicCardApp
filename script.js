...
/*
 * Esta medida NO controla el tamaño visible
 * de la brocha.
 *
 * Solo sirve para calcular cobertura.
 */
...
/*
 * TAMAÑO REAL DE LA BROCHA
 *
 * Más grande = menos pasadas.
 *
 * 68 px da un efecto de brocha amplia
 * y permite completar aproximadamente
 * en unas 6 pasadas.
 */

const TAMANO_BROCHA = 68;


/*
 * Distancia entre manchas del mismo trazo.
 *
 * Pequeña para que NO se vean bolitas
 * separadas.
 */
...
/*
 * Última posición del plumón.
 *
 * Se utiliza para unir una posición
 * con la siguiente.
 */

let ultimaPinturaX = null;
let ultimaPinturaY = null;
...
document.addEventListener(
  ...
  function(e) {
    ...
    /*
     * Reiniciamos el último punto
     * para comenzar un nuevo trazo.
     */
...
document.addEventListener(
  ...
  function(e) {
     ...
     *
     * Se conserva la posición que ya
     * permitía llegar a la orilla derecha.
     */
    ...
    /*
     * Si la punta entra en la carta,
     * comenzamos el trazo.
     */

    if (

      puntaX >= cardX - TAMANO_BROCHA / 2 &&
       ...
       * unimos ambos puntos.
       *
       * Esto elimina el efecto de bolitas.
       */
...
function pintarCarta(
  ...
  /*
   * Permitimos que la brocha pueda
   * sobresalir ligeramente de la carta.
   */
  ...
  if (
    ...
    /*
     * Aunque la zona ya esté registrada,
     * no regresamos aquí.
     *
     * El trazo visual puede continuar.
     */
  ...
  pintura.style.backgroundImage =
    'url("https://i.ibb.co/GvWHtsqK/IMG-8290.jpg")';


  pintura.style.backgroundRepeat =
    "no-repeat";
  ...
  /*
   * Alineamos la imagen azul exactamente
   * con la carta azul que está debajo.
   */
...
function revisarCarta() {
   ...
   * 60%:
   *
   * La brocha es grande y continua,
   * por lo que aproximadamente seis
   * pasadas amplias deben ser suficientes.
   */
