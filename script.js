...
document.addEventListener(
  ...
  function(e) {
    ...
    /*
     * VOLVEMOS A ACERCAR LA PUNTA
     * AL DEDO PARA ALCANZAR TODA
     * LA ORILLA DERECHA.
     */
...
function pintarCarta(x, y) {
  ...
  /*
   * USAMOS EL TAMAÑO REAL DE LA CARTA
   * PARA MANTENER LA ALINEACIÓN PERFECTA.
   */
  ...
  /*
   * MANTENEMOS LA PINTURA GRANDE
   * PARA CONSERVAR LAS 6–7 PASADAS.
   */
  ...
  /*
   * ESTA PARTE ES LA QUE MANTIENE
   * LA CARTA AZUL PERFECTAMENTE
   * ALINEADA CON LA ROJA.
   */
