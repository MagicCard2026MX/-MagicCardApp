...
const CARTA_ANCHO = 350;
const CARTA_ALTO = 490;
...
document.addEventListener(
  ...
  function(e) {
    ...
    /*
     * EL PLUMÓN SE MUEVE CON EL DEDO,
     * PERO SU PUNTA QUEDA DENTRO
     * DEL ÁREA ÚTIL.
     */
     ...
     *
     * El dedo controla la posición
     * del plumón y la punta entra
...
function pintarCarta(x, y) {
  ...
  /*
   * AHORA LA IMAGEN AZUL
   * TIENE EL MISMO TAMAÑO
   * QUE LA CARTA: 350 × 490.
   */
