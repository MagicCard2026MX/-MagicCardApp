...
function prepararImagenDeCarta() {
  ...
  /*
   * Los textos originales quedan
   * ocultos porque ahora usamos
   * la imagen real.
   */
...
function abrirCartasSecretas() {
  ...
  /*
   * CADA VEZ QUE ABRIMOS EL APARTADO
