 ...
 * Antes era 12.
 * Las zonas más grandes permiten que cada
 * pasada cubra mucho más de la carta.
 */
const TAMANO_ZONA = 20;
...
document.addEventListener(
  ...
  function(e) {
     ...
     * Es la posición que ya te permitía
     * alcanzar la orilla derecha.
     */
...
function pintarCarta(x, y) {
  ...
  /*
   * No modificamos la posición de la punta.
   */
  ...
  /*
   * La zona se coloca en el centro
   * para que no aparezcan bolitas aisladas.
   */
  ...
  /*
   * Mantiene la imagen azul alineada
   * con la carta que está debajo.
   */
...
function revisarCarta() {
  ...
  /*
   * 70% es suficiente.
   * Así no necesitas cubrir cada mancha.
   */
