...
/*
 * Mantengo la mecánica de cobertura,
 * pero ahora el plumón pinta una franja
 * continua siguiendo el movimiento del dedo.
 */
...
/*
 * Tamaño efectivo del pincel.
 *
 * La carta es 300 x 428.
 * Este tamaño permite cubrir mucho más
 * por cada pasada sin crear bolitas pequeñas.
 */

const TAMANO_PINCEL = 52;
...
document.addEventListener(
  ...
  function(e) {
    ...
    /*
     * Reiniciar el punto anterior
     * para comenzar una nueva pasada.
     */
...
document.addEventListener(
  ...
  function(e) {
    ...
    if (
      ...
      /*
       * Si ya existe un punto anterior,
       * rellenamos todo el recorrido
       * entre ambos puntos.
       *
       * Esto evita las bolitas separadas.
       */
...
function pintarLinea(
  ...
  /*
   * Más puntos cuando el dedo
   * se mueve rápido para que
   * no queden espacios.
   */
...
function pintarCarta(
  ...
  /*
   * El pincel cubre una zona amplia
   * alrededor del punto.
   */
