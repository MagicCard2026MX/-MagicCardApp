 ...
 *
 * Antes era 12 px.
 * Ahora cada zona es mucho mayor
 * para que la carta se cubra
 * aproximadamente en 5-6 pasadas.
 */

let zonasPintadas = new Set();

const TAMANO_ZONA = 30;
...
function pintarCarta(x, y) {
   ...
   * ZONAS GRANDES
   *
   * Esto hace que cada pasada
   * cubra mucho más área.
   */
  ...
  /*
   * Mantiene la misma mecánica
   * de pintura que ya tenías.
   */
