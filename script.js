...
/*
 * Tamaño de las zonas de pintura.
 * Se conserva la misma lógica.
 */

const TAMANO_ZONA = 35;
...
function pintarCarta(x, y) {
  ...
  /*
   * La pintura se adapta
   * al tamaño actual de la carta.
   */
...
function revisarCarta() {
  ...
  /*
   * Conservamos la misma idea:
   * aproximadamente 80% de cobertura.
   */
